<div id='search' class='u-full-width'>
    <div id="trail" class="container row">
        <ul>
            <li>Vous êtes ici :</li>
            <li><?php echo $result[0]["level_1"] ?></li>
        </ul>
    </div>
</div>
<section class='container'>
    <div class='row'>
        ...
        if(is_array($result)) {
            ...
            <div class='thumb'>
                <a href='./?p=home_detail&id=$txt_id' title=''>
                    <span class='rollover'><i>+</i></span>
                    <img src='upload/thumb/thumb_$txt_id-1.jpg' alt='' />
                </a>
            </div>
    
          <header>
            <h4><a href='./?p=home_detail&id=$txt_id' title=''>$txt_nom</a></h4>
                <div class='subheader'>
                ...
                <div class='une_txt'>
                    <p>
                        $txt_description
                        <a href='./?p=home_detail&id=$txt_id' title=''>[...]</a>
                        <b>$txt_price €</b>
                    </p>
                </div>
            </article>";
    ...
    <ul class='pagination'>
        ...
        echo "<li><a href='./?p=category&id=".$get_category_id."&start=1' title='premiers résultats'>$toFirstPage</a></li>
          <li><a href='./?p=category$previousPage' title='résultats précedent'>$previousSign</a></li>";
        ...
        for ($i=1; $i<=$totalPages; $i++){
            ...
            if ($i==1 || ($get_start-11)<$i && $i<($get_start+11) || $i==$totalPages){
                ...
                if($i==$totalPages && $get_start<($totalPages-11)){
                    ...
                    echo "<li><a href='./?p=category&id=".$get_category_id."&start=$i' class=$active>$i</a></li>";
                }
            }
        };
       ...
       suivante. Si on se trouve à la derniere page alors les boutons next et toLastPage ne s'affichent pas */
        ...
        echo "  
            <li><a href='./?p=category$next&id=".$get_category_id."' title='résultats suivants'>$nextSign</a></li>
            <li><a href='./?p=category&start=$totalPages&id=".$get_category_id."' title='derniers résultats'>$toLastPage</a></li> ";
